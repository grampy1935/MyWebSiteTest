...
Ensemble members can toggle Self-Ensemble Mode on or off by tapping the iPhone icon when playback is paused. When Self-Ensemble Mode is turned on, playback of the currently set score begins. You can then practice ensemble playing by performing gestures in sync with this playback.