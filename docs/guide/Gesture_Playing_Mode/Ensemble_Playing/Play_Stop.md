...
なおアンサブルのメンバーは、演奏の停止時にiPhoneアイコンをタップすることにより、セルフ・アンサンブル・モードのオン／オフを切り替えることが可能です。セルフ・アンサンブル・モードをオンにすると、現在設定されているスコアの演奏が開始されるので、その演奏に合わせてジェスチャー演奏を行うことによりアンサンブル演奏の練習を行うことができます。
